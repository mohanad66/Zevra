...
export default function WalletDetail() {
  ...
  useEffect(() => {
    client
      ...
      .catch((err) => toast((err?.response?.data?.detail) || 'Failed to load wallet', 'error'))
  }, [coinId])
  ...
  return (
    <div className="page">
      ...
      <section className="section">
        <h3>Investments</h3>
        <Table
          cols={['Amount', 'Status', 'TX hash', 'Date']}
      ...
      <section className="section">
        <h3>Withdrawals</h3>
        <Table
          cols={['Amount', 'Address', 'Fee', 'Status', 'Date']}
      ...
      <section className="section">
        <h3>Referral awards</h3>
        <Table
          cols={['Level', 'Percent', 'Amount', 'From', 'Date']}
          rows={data.awards.map((a) => [`Level ${a.level}`, `${a.percent}%`,
